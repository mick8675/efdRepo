 ...
 */
public class NativeSecuritySetupTaskIT {
    
    public NativeSecuritySetupTaskIT() {
    }
    ...
    /**
     * Test of getPasswordConsole method, of class NativeSecuritySetupTask.
     */
    @Test
    public void testGetPasswordConsole() {
        System.out.println("getPasswordConsole");
        NativeSecuritySetupTask instance = new NativeSecuritySetupTask();
